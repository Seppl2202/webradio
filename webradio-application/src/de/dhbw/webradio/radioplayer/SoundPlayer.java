...
public class SoundPlayer implements Runnable {
    ...
    /**
     * damit mp3-Dateien abgespielt werden k�nnen, muss das mp3plugin von Sun im Classpath stehen oder
     * (zB. unter Eclipse) als Bibliothek eingetragen sein.
     * Das gleiche gilt f�r flac-Dateien.
     *
     * Die Lautst�rke "gainLevel" ist logarhytmisch von -80dB bis ca. 6dB. Daher ist die
     * prozentuale Lautst�rkeregelung nicht ganz korrekt.
     */
